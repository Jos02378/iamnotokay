        ...
        new Promise((resolve, reject) => {
            if (Object.keys(toxicityModel).length > 0) {
                toxicityModel
                    .classify(story)
                    .then((predictions) => {
                        resolve(predictions.map((item) => item?.results[0]?.match));
                    })
                    ...
                    try {
                        db.collection('stories')
                            .add({
                                ...
                                story,
                                anonymous: isAnonymous,
                                owner: 'IPM5IT9pLdgYeAAQ6lR8eWQrrln2',
    ...
    return (
        <>
            ...
            <form className="write__wrapper" autoComplete="off">
                ...
                <Modal
                    title="We're sorry to tell you that we detect a presence of toxicity in your message"
                    description="Please revise your chosen words and sentences."
                    buttons={[
                        {
                            text: 'Okay',
                            onClick: () => {
